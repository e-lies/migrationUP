...
export default function SpeedDials(props) {
  const {
    ...
    data,
    classes: propClasses,
  } = props; //actions a la forme [{icon:'',label:'',fct:..},{icon:....},...]
  ...
  return (
    <SpeedDial
      ...
      open={open}
      direction={direction}
      classes={{ root: propClasses && propClasses.root }}
    >
      {actions.map((action) => {
        return (
          <SpeedDialAction
            ...
            onClick={(e) => {
              setOpen(false);
              actionClick(action.fct, action.label);
            }}
          />
        );
      })}
...
SpeedDials.propTypes = {
  ...
  /** Data passed to the function call (line data) */
