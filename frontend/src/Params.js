export const path = "/"; //"http://localhost:3001/"; //http://130.211.108.62"; //"http://numental.fr/Mtek";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: ".....",
            description:
              "Les préparations dirigées à mon magasin ou sans magasin",
          },
          {
            id: "Validation",
            label: "A valider",
            icon: "check_all",
            description:
              "Regrouper par mouvement, puis par demande_mouvement, puis par aes, avec possibilité d'inventaire",
          },
          {
            id: "Commandes",
          ...
          },
          {
            ...
            icon: "history",
            description:
              "Regrouper par mouvement, puis par demande_mouvement, puis par aes, et possibilité d'impression",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            icon: "input",
            description:
              "Liste de vos approvisionnements que vous pouvez accepter ou refuser",
          },
          {
            id: "EnAttente",
          ...
          },
          {
            ...
            icon: "history",
            description:
              "Historique de tous les articles avec lesquels vous avez été approvisionné",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            description: "Créer une nouvelle vente ou continuer une précédente",
          },
          {
            id: "Virtuelle",
        ...
        children: [
          {
            ...
            icon: "swap_horiz",
            description:
              "Liste de vos clients avec possibilité de faire des versements ou des encaissements avec chacun d'entre eux",
          },
          {
            id: "Historique",
            label: "Historique",
